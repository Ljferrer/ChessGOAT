...
**YOU ARE IN: `ChessGOAT/polecats/furiosa/`** — This is YOUR worktree. Stay here.

- **ALL file operations** must be within this directory
- **Use absolute paths** when writing files
- **NEVER** write to `~/gt/ChessGOAT/` (rig root) or other directories
...
**Your mail address:** `ChessGOAT/polecats/furiosa`
**Your rig:** ChessGOAT
**Your Witness:** `ChessGOAT/witness`
...
| Ask Witness for help | `gt mail send ChessGOAT/witness -s "HELP" -m "..."` | ~~gt nudge witness~~ |

---

## When to Ask for Help

Mail your Witness (`ChessGOAT/witness`) when:
...
```bash
gt mail send ChessGOAT/witness -s "HELP: <problem>" -m "Issue: ...
Problem: ...
Tried: ...
Question: ..."
```
